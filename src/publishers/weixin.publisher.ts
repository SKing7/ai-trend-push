...
import { getConfigService } from 'src/lib/config';
...
export class WeixinPublisher {
  ...
  init() {
    ...
    this.appId = configService.get('WEIXIN_APP_ID');
    this.appSecret = configService.get('WEIXIN_APP_SECRET');
  }
